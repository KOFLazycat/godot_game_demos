...
# 删除指定行
func removeColumnsFromMatrix(matrix: Array[Array], columnIndexList: Array):
	var retMatrix: Array[Array] = []
...
# 删除指定列
func removeRowsFromMatrix(matrix: Array[Array], rowIndexList: Array):
